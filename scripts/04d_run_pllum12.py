"""
Faza 4d: PLLuM-12B-instruct (text-only przez mlx-lm) na 20 zadaniach.

PLLuM-12B-instruct to flagowy model rodziny CYFRAGOVPL, dense 12B parametrów,
**natywna architektura** (nie Llama-based, jak Llama-PLLuM-8B). Sprawdza, czy
katastrofalny wynik Llama-PLLuM-8B (3/30) to artefakt mniejszej wersji, czy
problem całej rodziny PLLuM.

Wagi MLX Q6 z `lukagra/PLLuM-12B-instruct-Q6-mlx`. Wynik: results/pllum12_odpowiedzi.json
"""
...
MODEL_ID = "lukagra/PLLuM-12B-instruct-Q6-mlx"
...
OUT = ROOT / "results" / "pllum12_odpowiedzi.json"
